...
3. Configure DB environment variables using your own MySQL credentials.
   Use `.env.example` as the reference values to set in your shell.
...
For a step-by-step guide suitable for tutors or teammates, see:
